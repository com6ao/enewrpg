    ...
    <div style={{ display:"grid", gap:12, ...wrap }}>
      <div style={card}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10 }}>
          <button style={{ ...slotBase, gridColumn:"2 / span 1" }}>Elmo</button>
          <button style={{ ...slotBase, gridColumn:"1 / span 1" }}>Arma</button>
          <button style={{ ...slotBase, gridColumn:"1 / span 1" }}>Anel</button>
          <div style={{
            gridColumn:"2 / span 1", height:112, borderRadius:12,
          ...
          <button style={{ ...slotBase, gridColumn:"3 / span 1" }}>Escudo</button>
          <button style={{ ...slotBase, gridColumn:"3 / span 1" }}>Peitoral</button>
          <button style={{ ...slotBase, gridColumn:"2 / span 1" }}>Calças</button>
          <button style={{ ...slotBase, gridColumn:"3 / span 1" }}>Botas</button>
        </div>
      </div>
